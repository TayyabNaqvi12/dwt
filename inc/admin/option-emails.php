...
&nbsp;',
        ...
        array(
            ...
            'type' => 'text',
            'title' => __('Booking Approved', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Booking Approved - DWT Listing',
        ),
        array(
...
&nbsp;',
        ...
        array(
            ...
            'type' => 'text',
            'title' => __('Booking Rejected', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Booking Rejected - DWT Listing',
        ),
...
&nbsp;',
        ...
        //event approved status subject
        array(
            'id' => 'dwt_listing_event_ticket_approved_subject',
            'type' => 'text',
            'title' => __('Your Ticket has been Approved', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Tickets Approved - DWT Listing',
        ),
        array(
            'id' => 'dwt_listing_event_ticket_approved_message',
            'type' => 'editor',
            'title' => esc_html__('Ticket Approved Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
...
<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"><span style="font-family: sans-serif; font-weight: normal;">Hello %user%</span><span style="font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif;"><b>,</b></span></p>
Your Tickets Has Been Approved.
<br />
...
&nbsp;',
        ...
        array(
            'id' => 'dwt_listing_events_tickets_rejected_subject',
            'type' => 'text',
            'title' => __('Your Ticket has been Rejected', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Tickets Rejected - DWT Listing',
        ),
       
        array(
            
            'id' => 'dwt_listing_events_ticket_rejected_message',
            'type' => 'editor',
            'title' => esc_html__('Ticket Rejected Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
...
&nbsp;',
        ...
        //payouts accepted and rejected
        array(
            'id' => 'dwt_listing_payout_approved_subject',
            'type' => 'text',
            'title' => __('Payout Approved', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Payout Approved - DWT Listing',
        ),
        array(
            'id' => 'dwt_listing_payout_status_approved_message',
            'type' => 'editor',
            'title' => esc_html__('Payout Approved Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
...
&nbsp;',
        ...
        //booking status rejected
        array(
            'id' => 'dwt_listing_payout_rejected_subject',
            'type' => 'text',
            'title' => __('payout Rejected', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'payout Rejected - DWT Listing',
        ),
       
        array(
            
            'id' => 'dwt_listing_payout_status_rejected_message',
            'type' => 'editor',
            'title' => esc_html__('payout Rejected Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
...
<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"><span style="font-family: sans-serif; font-weight: normal;">Hello %user%</span><span style="font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif;"><b>,</b></span></p>
Unfortunately, your payout has been rejected.
<br />
